	...
	angular.module('MailBox')
	  ...
	  `
	     <div class="row">
	     <mail-box-menu show-mail-list="$ctrl.showMailList()"></mail-box-menu>
        <div id="detail-view" class="detail-view col-sm-10">
          <mail-list mails="$ctrl.mails" show-mail-item="$ctrl.showMailItem(index)" ng-if="$ctrl.mailListVisible"></mail-list>
          <mail-item-full-view mails="$ctrl.mails" index="$ctrl.index" ng-if="$ctrl.mailDetailsVisible"></mail-item-full-view>
        </div>
       </div>
      `,
	...
	function MailBoxController () {
	  var $ctrl = this;
	    $ctrl.mails = mails;
	    $ctrl.mailListVisible = true;
	    $ctrl.mailDetailsVisible = false;

	    function showMailItem(index) {
	     $ctrl.index = index;
          $ctrl.mailListVisible = false;
          $ctrl.mailDetailsVisible = true;
	    }
	    this.showMailItem = showMailItem;
	    $ctrl.test =function() {
	    	alert('test successful')
	    }

		$ctrl.showMailList = function() {
		$ctrl.mailListVisible = true;
          $ctrl.mailDetailsVisible = false;
				};
	    };
